                ...
                <form  accept-charset="utf-8" class="update-member-account-settings" >
												<div class="row mb-3">
													<div class="col-12 mb-3">
														<div class="er-field-wrap">
															<label for="name" class="float-left"><?php esc_html_e('NAME(BLOCK LETTER)','cooalliance')?></label>
												...
												<div class="row mb-3">
													<div class="col-xs-12 col-md-4">
														<div class="er-field-wrap">
															<label for="dateOfBirth" class="float-left"><?php esc_html_e('Date Of Birth','cooalliance')?></label>
												...
												<div class="row mt-5 mb-3">
													<div class="col-xs-6 col-md-12">
														<div class="register-btn-wrapper text-left">
															<button class="btn btn-lg btn-primary signup-btn rounded-0" type="submit"><?php esc_html_e('Update Account Settings','cooalliance')?></button>
														</div>
													</div>
												</div>
