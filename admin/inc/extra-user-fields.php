...
function extra_user_profile_fields( $user ) { ?>
    ...
    <table class="form-table">
        ...
        <tr>
            <th>
                <label for="title"><?php _e("Title",'cooalliance'); ?></label>
            </th>
            <td>
        ...
        <tr>
            <th>
                <label for="company_name"><?php _e("Company Name",'cooalliance'); ?></label>
            </th>
            <td>
        ...
        <tr>
            <th>
                <label for="industry"><?php _e("Industry",'cooalliance'); ?></label>
            </th>
            <td>
        ...
        <tr>
            <th>
                <label for="join_date"><?php _e("Date joined",'cooalliance'); ?></label>
            </th>
            <td>
        ...
        <tr>
            <th>
                <label for="cell_number"><?php _e("Cell Number",'cooalliance'); ?></label>
            </th>
            <td>
        ...
        <tr>
            <th>
                <label for="address"><?php _e("Address",'cooalliance'); ?></label>
            </th>
            <td>
        ...
        <tr>
            <th>
                <label for="city"><?php _e("City",'cooalliance'); ?></label>
            </th>
            <td>
        ...
        <tr>
            <th>
                <label for="state"><?php _e("State",'cooalliance'); ?></label>
            </th>
            <td>
        ...
        <tr>
            <th>
                <label for="country"><?php _e("Country",'cooalliance'); ?></label>
            </th>
            <td>
        ...
        <tr>
            <th>
                <label for="birthdate"><?php _e("Birthdate",'cooalliance'); ?></label>
            </th>
            <td>
        ...
        <tr>
            <th>
                <label for="about_me"><?php _e("About Me",'cooalliance'); ?></label>
            </th>
            <td>
    ...
    <?php echo esc_attr( get_the_author_meta( 'about_me', $user->ID ) ); ?>
        ...
        <tr>
            <th>
                <label for="facebook"><?php _e("Facebook",'cooalliance'); ?></label>
            </th>
            <td>
        ...
        <tr>
            <th>
                <label for="linkedin"><?php _e("Linkedin",'cooalliance'); ?></label>
            </th>
            <td>
